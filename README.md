...
3 ошибка: 
	В строчке 291 неверно считается 3\cdotsizeof(stack), так как stack - указатель на структуру Stack, поэтому 3*sizeof(stack) = 12. (А не нужные в этом месте 32 байта)
